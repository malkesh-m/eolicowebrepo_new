const pastauctions = document.querySelector('#pastauctions')
...
function getMyArtworksDataSetter(queryParamas, start, limit) {
    fetch(`/login/getMyArtworks/?start=${start}&${queryParamas}limit=${limit}`, {
        method: 'GET',
    })
        ...
        .then(body => {
            ...
            pastauctions.innerHTML = htmlData
        })
}
...
function filterAuction(e) {
    ...
    getMyArtworksDataSetter(queryParams, 0, limit)
}

document.addEventListener('DOMContentLoaded', function () {
    document.querySelector('#lotLowToHighCheckId').checked = true
    getMyArtworksDataSetter('lotLowToHigh=true&', 0, 50)
})
